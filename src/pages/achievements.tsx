...
export const AchievementsPage = () => {
  return (
    <section className="h-svh w-full bg-[#050505] px-4 sm:px-10 pb-[86px] pt-6 sm:pt-[86px] flex flex-col items-center overflow-y-auto">
      <div className="flex flex-col w-full gap-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <AchievementCard
              image="/certificates/react certificate.png"
            ...
            />
            <AchievementCard
              image="/certificates/javascript certificate.png"
            ...
            />
            <AchievementCard
              image="/certificates/data-structure.png"
