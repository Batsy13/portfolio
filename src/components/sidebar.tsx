    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-2 mt-2">
          <AnimatedShinyText
            className={`py-2 px-1 ${
              isCollapse ? "text-center text-[12px]" : ""
            }`}
          >
            Contact me
          </AnimatedShinyText>
        ...
        >
          {isCollapse ? (
            <ChevronRight className="h-4 w-4 transition-transform duration-200 ease-in-out text-white hover:text-[#FFF] cursor-pointer" />
          ) : (
            <ChevronLeft className="h-4 w-4 transition-transform duration-200 ease-in-out text-white hover:text-[#FFF] cursor-pointer" />
          )}
        </button>
      </aside>
